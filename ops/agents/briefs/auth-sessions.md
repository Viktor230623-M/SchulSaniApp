...
BEREICH: AREA: Sitzungen & Sessions (artifacts/api-server/src/lib/sessions.ts, sessionRules.ts, authTokens.ts). Prüfe: Token-Format, Ablauf/Expiry, Rotation, Revocation/Logout, Brute-Force-Schutz, Concurrent-Session-Handling, Speicherort, Leak-Risiken.
