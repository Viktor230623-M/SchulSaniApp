...
BEREICH: AREA: PDF-Export (paramedic-app/services/reportPdfClient.ts, app/report/, api-server routes/exports.ts, lib/exportIntervals.ts). Prüfe: Client-/Server-seitige PDF-Generierung, XSS/Scripting in PDFs, Datenleck-Risiken, Löschung nach Download, Bundle-Export, Zugriffskontrolle.
