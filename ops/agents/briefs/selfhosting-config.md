...
BEREICH: AREA: Selbsthosting & Konfiguration (artifacts/api-server/src/config.ts, .env.example*, ops/install/*, README Deploy-Sektionen). Prüfe: Env-basierte Config, Secrets-Handling, Docker/Systemd, HTTPS, Health-Checks, Migrations beim Update, Dokumentation.
