...
BEREICH: AREA: Abhängigkeiten & Supply Chain (pnpm-lock.yaml, artifacts/*/package.json, .npmrc). Prüfe: Lockfile eingecheckt, bekannte Schwachstellen (audit), veraltete Pakete, Lizenzrisiken, Registry-Pinning, verdächtige Pakete.
