...
BEREICH: AREA: Autorisierung & Rollen (lib/permissions.ts, rolePermissions.ts, permissionMatrix.test.ts, routes/admin, roles.ts, users.ts). Prüfe: RBAC-Matrix, serverseitige Checks auf jeder Route, Privilege-Escalation-Pfade, Admin-Endpoints, Least-Privilege, Rollenwechsel-Protokoll.
