...
BEREICH: AREA: Client-Sicherheit (paramedic-app/services/crypto/secureStore.ts, ApiService.ts Token-Handling, app/_layout.tsx, deep links). Prüfe: Token-Speicherung (Keychain vs AsyncStorage), Tokens im Speicher vs persistent, Deep-Link-Validierung, WebView-Nutzung, ob Secrets im Bundle sind.
