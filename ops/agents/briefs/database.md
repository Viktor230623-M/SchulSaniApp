...
BEREICH: AREA: Datenbank & Datenmodell (artifacts/api-server/src/data/, lib/*.ts Queries, ops/install). Prüfe: Schema/Migrationen, Indexe, N+1, Transaktionen, Constraints, Backups, ob Queries den Tenant filtern, Prepared Statements.
