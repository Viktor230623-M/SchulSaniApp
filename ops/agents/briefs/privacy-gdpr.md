...
BEREICH: AREA: Datenschutz/GDPR (lib/retentionRules.ts, jobs/retention.ts, routes/exports.ts, users.ts Löschung, data/. Prüfe: Datenminimierung, Aufbewahrungsfristen, Anonymisierung (23-Uhr-Job), Export & Löschung, Einwilligung, Logs mit PII, Drittverarbeiter.
