...
export default function FreischaltungWartenScreen() {
  ...
  const [message, setMessage] = useState(t("auth.registerSuccess", useAppStore.getState().language));
  ...
  return (
    <AuthShell theme={theme} title={t("auth.verifyHeading", lang)} body={t("auth.registerBody", lang)}>
