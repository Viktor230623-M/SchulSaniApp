...
const translations = {
  de: {
    ...
    settings: {
      ...
      correctNameTitle: "Namen korrigieren",
      correctNameConfirm: "{name} in \"{firstName} {lastName}\" ändern?",
      correctNameFailed: "Name konnte nicht korrigiert werden",
      logout: "Abmelden",
  ...
  en: {
    ...
    settings: {
      ...
      correctNameTitle: "Correct name",
      correctNameConfirm: "Change {name} to \"{firstName} {lastName}\"?",
      correctNameFailed: "Could not correct name",
      logout: "Sign Out",
