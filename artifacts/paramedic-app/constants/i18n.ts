...
const translations = {
  de: {
    ...
    settings: {
      ...
      themeCrimson: "Karmesinrot (CTO)",
      themeMidnight: "Mitternacht (CTO)",
      themeSunset: "Sonnenuntergang (CTO)",
      themeAmethyst: "Amethyst (CTO)",
  ...
  en: {
    ...
    settings: {
      ...
      themeRed: "Red",
      themeTeal: "Teal (CTO)",
      themeCrimson: "Crimson (CTO)",
      themeMidnight: "Midnight (CTO)",
      themeSunset: "Sunset (CTO)",
      themeAmethyst: "Amethyst (CTO)",
      allUsers: "All Users",
