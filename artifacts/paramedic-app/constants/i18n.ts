...
const translations = {
  de: {
    ...
    auth: {
      ...
      providersLoadFailed: "Anmeldewege konnten nicht geladen werden. Formularanmeldung wird verwendet.",
  ...
  en: {
    ...
    auth: {
      ...
      providersLoadFailed: "Could not load sign-in options. Falling back to the sign-in form.",
